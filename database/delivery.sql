...
create table repartidor(
    idDeliver INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
ALTER TABLE repartidor AUTO_INCREMENT = 100;
...
ALTER TABLE venta AUTO_INCREMENT = 200000;
...
create table detalle(
    ...
    lot INT(3) NOT NULL,
    CONSTRAINT fk_producto1 FOREIGN KEY (idProduct) REFERENCES producto(idProduct),
    CONSTRAINT fk_venta FOREIGN KEY (idSale) REFERENCES venta(idSale)
);
ALTER TABLE detalle AUTO_INCREMENT = 1000000;
